...
public class ModelCheckerTest {
    ...
    public void mutexTest() {
        try {
            ...
            StateFormula fairnessConstraint = new FormulaParser("src/test/resources/querystrongfair.json").parse();
            StateFormula query = new FormulaParser("src/test/resources/querystrongfair.json").parse();
